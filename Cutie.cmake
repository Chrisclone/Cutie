...
function(add_cutie_test_targets)
    ...
    foreach(TEST_FILE ${_TESTS})
        add_cutie_test_target(TEST ${TEST_FILE} SOURCES ${_SOURCES} COMPILER_FLAGS ${_COMPILER_FLAGS} COMPILER_DEFINITIONS ${_COMPILER_DEFINITIONS} LINKER_FLAGS ${_LINKER_FLAGS} INCLUDE_DIRECTORIES ${_INCLUDE_DIRECTORIES} LINK_LIBRARIES ${_LINK_LIBRARIES})
    endforeach()
endfunction()
